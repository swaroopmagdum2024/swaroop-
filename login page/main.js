...
// Google Sign-In (using your Google OAuth Client ID with hardcoded redirect_uri)
const GOOGLE_CLIENT_ID = '967513176540-fkfpbpm5mscb0mu1jbj95djiu0udna03.apps.googleusercontent.com';

document.getElementById('googleSignIn').addEventListener('click', () => {
  const redirect_uri = 'http://127.0.0.1:5501'; // Must match exactly what is set in Google Cloud Console
  const oauthUrl =
